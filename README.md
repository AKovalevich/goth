# Goth: Multi-Provider Authentication for Go [![GoDoc](https://godoc.org/github.com/AKovalevich/goth?status.svg)](https://godoc.org/github.com/AKovalevich/goth) [![Build Status](https://travis-ci.org/markbates/goth.svg)](https://travis-ci.org/markbates/goth)
...
```text
$ go get github.com/AKovalevich/goth
```
