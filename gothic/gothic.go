...
See https://github.com/AKovalevich/goth/blob/master/examples/main.go to see this in action.
*/
package gothic
...
See https://github.com/AKovalevich/goth/examples/main.go to see this in action.
*/
